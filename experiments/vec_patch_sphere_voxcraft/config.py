from renesis.env.vec_voxcraft import (
    VoxcraftSingleRewardVectorizedPatchSphereEnvironment,
)
from experiments.vec_patch_sphere_voxcraft.utils import *
...
config = {
    "env": VoxcraftSingleRewardVectorizedPatchSphereEnvironment,
    "env_config": {
        "debug": False,
